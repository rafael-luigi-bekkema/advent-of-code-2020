...
func ExampleSolutions_Puzzle10() {
	fmt.Println(solutions.Puzzle10())

	// Output: 2470
}

func TestPuzzle10b(t *testing.T) {
	tt := []struct {
		data   string
		expect int
	}{
...
func ExampleSolutions_Puzzle10b() {
	fmt.Println(solutions.Puzzle10b())

	// Output: 1973822685184
}
